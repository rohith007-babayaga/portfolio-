...
const Contact: React.FC = () => {
  ...
  // UPDATE WITH YOUR ACTUAL CONTACT INFORMATION FROM RESUME
  const contactInfo = [
    {
      icon: FiMail,
      title: 'Email',
      value: 'rohithkumar.p20@gmail.com',
      link: 'mailto:rohithkumar.p20@gmail.com'
    },
    {
      icon: FiPhone,
      title: 'Phone',
      value: '+19342464279',
      link: 'tel:+19342464279'
    },
    {
      icon: FiMapPin,
      title: 'Location',
  ...
  const socialLinks = [
    {
      icon: FiGithub,
      name: 'GitHub',
      url: 'https://github.com/rohith007-babayaga'
    },
    {
      icon: FiLinkedin,
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/rohith-kumar-2a1a69249/'
    },
            ...
            <div className="space-y-6">
              {contactInfo.map((info, index) => (
                <motion.a
                  ...
                  className="flex items-center p-4 rounded-lg bg-gray-50 dark:bg-dark-800 hover:bg-gray-100 dark:hover:bg-dark-700 transition-colors duration-200"
                >
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    className="p-3 rounded-full bg-gray-100 dark:bg-dark-700 hover:bg-gray-200 dark:hover:bg-dark-600 transition-colors duration-200 text-gray-700 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400"
                  >
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Rohith Kumar Pittala"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 border border-gray-300 dark:border-dark-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent bg-white dark:bg-dark-800 text-gray-900 dark:text-white"
                    placeholder="rohithkumar.p20@gmail.com"
                  />
                </div>
              </div>
              <div>
